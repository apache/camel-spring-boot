...
@SpringBootTest(
    classes = {
        ...
        JacksonMarshalUnmarshalPojoArrayTest.class,
        JacksonMarshalUnmarshalPojoArrayTest.TestConfiguration.class
    }
)

public class JacksonMarshalUnmarshalPojoArrayTest {
