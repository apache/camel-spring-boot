 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DebeziumPostgresComponentConverter.class})
...
public class DebeziumPostgresComponentAutoConfiguration {
    ...
    private final DebeziumPostgresComponentConfiguration configuration;

    public DebeziumPostgresComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.debezium.postgres.springboot.DebeziumPostgresComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.debezium-postgres", configuration, target);
            }
            @Override
