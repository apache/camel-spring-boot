...
public class FilesComponentAutoConfiguration {
    ...
    private final FilesComponentConfiguration configuration;

    public FilesComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.file.azure.springboot.FilesComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.azure-files", configuration, target);
            }
            @Override
