...
import org.apache.camel.language.wasm.WasmLanguage;
...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,WasmLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.wasm"})
public class WasmLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final WasmLanguageConfiguration configuration;

    public WasmLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.wasm.springboot.WasmLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureWasmLanguage() {
