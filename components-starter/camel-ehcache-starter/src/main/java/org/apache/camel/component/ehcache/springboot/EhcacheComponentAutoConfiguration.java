 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, EhcacheComponentConverter.class})
...
public class EhcacheComponentAutoConfiguration {
    ...
    private final EhcacheComponentConfiguration configuration;

    public EhcacheComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.ehcache.springboot.EhcacheComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof EhcacheComponent;
            }
        };
    }
}