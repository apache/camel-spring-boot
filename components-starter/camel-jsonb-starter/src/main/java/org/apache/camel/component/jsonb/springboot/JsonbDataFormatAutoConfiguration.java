 ...
 */
package org.apache.camel.component.jsonb.springboot;
...
public class JsonbDataFormatAutoConfiguration {
    ...
    private final JsonbDataFormatConfiguration configuration;

    public JsonbDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.component.jsonb.springboot.JsonbDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureJsonbDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.jsonb", configuration, target);
            }
            @Override
