...
public class LangChain4jWebSearchComponentAutoConfiguration {
    ...
    private final LangChain4jWebSearchComponentConfiguration configuration;

    public LangChain4jWebSearchComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.langchain4j.web.search.springboot.LangChain4jWebSearchComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.langchain4j-web-search", configuration, target);
            }
            @Override
