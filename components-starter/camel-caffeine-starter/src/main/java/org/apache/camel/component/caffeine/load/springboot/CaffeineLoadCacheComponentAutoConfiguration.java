 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CaffeineLoadCacheComponentConverter.class})
...
public class CaffeineLoadCacheComponentAutoConfiguration {
    ...
    private final CaffeineLoadCacheComponentConfiguration configuration;

    public CaffeineLoadCacheComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.caffeine.load.springboot.CaffeineLoadCacheComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.caffeine-loadcache", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof CaffeineLoadCacheComponent;
            }
        };
    }
}