 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CaffeineCacheComponentConverter.class})
...
public class CaffeineCacheComponentAutoConfiguration {
    ...
    private final CaffeineCacheComponentConfiguration configuration;

    public CaffeineCacheComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.caffeine.cache.springboot.CaffeineCacheComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.caffeine-cache", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof CaffeineCacheComponent;
            }
        };
    }
}