 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, KuduComponentConverter.class})
...
public class KuduComponentAutoConfiguration {
    ...
    private final KuduComponentConfiguration configuration;

    public KuduComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.kudu.springboot.KuduComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof KuduComponent;
            }
        };
    }
}