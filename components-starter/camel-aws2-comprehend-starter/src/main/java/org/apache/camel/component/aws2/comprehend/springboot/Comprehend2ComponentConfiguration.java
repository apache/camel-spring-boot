 ...
 */
@ConfigurationProperties(prefix = "camel.component.aws2-comprehend")
public class Comprehend2ComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the aws2-comprehend component.
     * This is enabled by default.
     */
    private Boolean enabled;
    /**
     * Component configuration. The option is a
     * org.apache.camel.component.aws2.comprehend.Comprehend2Configuration type.
     */
    ...
    /**
     * The language code of the input text. Required for all operations except
     * detectDominantLanguage. Use a 2-letter ISO 639-1 code (e.g., 'en' for
    ...
    /**
     * The region in which the Comprehend client needs to work. When using this
    ...
    /**
     * To use an existing configured AWS Comprehend client. The option is a
     * software.amazon.awssdk.services.comprehend.ComprehendClient type.
     */
