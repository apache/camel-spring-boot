...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,PGPDataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.pgp"})
public class PGPDataFormatAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final CamelContext camelContext;
    private final PGPDataFormatConfiguration configuration;

    public PGPDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.CamelContext camelContext,
            org.apache.camel.converter.crypto.springboot.PGPDataFormatConfiguration configuration) {
