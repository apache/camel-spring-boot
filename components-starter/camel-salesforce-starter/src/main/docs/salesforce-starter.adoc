...
| *camel.component.salesforce.config.approval* |  |  | ApprovalRequest
...
| *camel.component.salesforce.http-client.max-content-length* |  |  | Integer
| *camel.component.salesforce.http-client.max-retries* |  |  | Integer
| *camel.component.salesforce.http-client.session* |  |  | SalesforceSession
| *camel.component.salesforce.http-client.timeout* |  |  | Long
...
| *camel.component.salesforce.login-config.client-id* | OAuth Consumer Key of the connected app configured in the Salesforce instance setup. Typically a connected app needs to be configured but one can be provided by installing a package. |  | String
| *camel.component.salesforce.login-config.client-secret* | OAuth Consumer Secret of the connected app configured in the Salesforce instance setup. |  | String
| *camel.component.salesforce.login-config.instance-url* | URL of the Salesforce instance used after authentication, by default received from Salesforce on successful authentication |  | String
...
| *camel.component.salesforce.login-config.lazy-login* | If set to true prevents the component from authenticating to Salesforce with the start of the component. You would generally set this to the (default) false and authenticate early and be immediately aware of any authentication issues. | false | Boolean
| *camel.component.salesforce.login-config.login-url* | URL of the Salesforce instance used for authentication, by default set to \https://login.salesforce.com | https://login.salesforce.com | String
...
| *camel.component.salesforce.report-metadata.aggregates* |  |  | String[]
| *camel.component.salesforce.report-metadata.currency* |  |  | String
| *camel.component.salesforce.report-metadata.detail-columns* |  |  | String[]
| *camel.component.salesforce.report-metadata.developer-name* |  |  | String
| *camel.component.salesforce.report-metadata.groupings-across* |  |  | GroupingInfo[]
| *camel.component.salesforce.report-metadata.groupings-down* |  |  | GroupingInfo[]
| *camel.component.salesforce.report-metadata.historical-snapshot-dates* |  |  | String[]
| *camel.component.salesforce.report-metadata.id* |  |  | String
| *camel.component.salesforce.report-metadata.name* |  |  | String
| *camel.component.salesforce.report-metadata.report-boolean-filter* |  |  | String
| *camel.component.salesforce.report-metadata.report-filters* |  |  | ReportFilter[]
| *camel.component.salesforce.report-metadata.report-format* |  |  | ReportFormatEnum
| *camel.component.salesforce.report-metadata.report-type* |  |  | ReportType
