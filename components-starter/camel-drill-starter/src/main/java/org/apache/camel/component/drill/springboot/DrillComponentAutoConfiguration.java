...
public class DrillComponentAutoConfiguration {
    ...
    private final DrillComponentConfiguration configuration;

    public DrillComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.drill.springboot.DrillComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DrillComponent;
            }
        };
    }
}