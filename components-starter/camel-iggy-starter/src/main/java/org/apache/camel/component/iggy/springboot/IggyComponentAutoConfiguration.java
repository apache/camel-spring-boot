 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, IggyComponentConverter.class})
...
public class IggyComponentAutoConfiguration {
    ...
    private final IggyComponentConfiguration configuration;

    public IggyComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.iggy.springboot.IggyComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.iggy", configuration, target);
            }
            @Override
