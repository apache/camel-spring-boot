 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, InfinispanEmbeddedComponentConverter.class})
...
public class InfinispanEmbeddedComponentAutoConfiguration {
    ...
    private final InfinispanEmbeddedComponentConfiguration configuration;

    public InfinispanEmbeddedComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.infinispan.embedded.springboot.InfinispanEmbeddedComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.infinispan-embedded", configuration, target);
            }
            @Override
