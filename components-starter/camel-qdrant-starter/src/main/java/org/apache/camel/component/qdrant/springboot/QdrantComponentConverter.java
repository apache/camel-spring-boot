...
@Component
public class QdrantComponentConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
        ...
        answer.add(new ConvertiblePair(String.class, io.qdrant.client.grpc.Common.Filter.class));
        return answer;
    }
    ...
    public Object convert(
        ...
        switch (targetType.getName()) {
            ...
            case "io.qdrant.client.grpc.Common.Filter": return applicationContext.getBean(ref, io.qdrant.client.grpc.Common.Filter.class);
        }
        return null;
    }
}