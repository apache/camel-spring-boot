 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DataLakeComponentConverter.class})
...
public class DataLakeComponentAutoConfiguration {
    ...
    private final DataLakeComponentConfiguration configuration;

    public DataLakeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.azure.storage.datalake.springboot.DataLakeComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.azure-storage-datalake", configuration, target);
            }
            @Override
