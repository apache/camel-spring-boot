 ...
 */
package org.apache.camel.component.alibaba.kms.springboot;
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.alibaba-kms"})
public class KMSComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final KMSComponentConfiguration configuration;

    public KMSComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.alibaba.kms.springboot.KMSComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                        ...
                        "camel.component.alibaba-kms.customizer")
