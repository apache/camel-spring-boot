...
public class UniVocityTsvDataFormatAutoConfiguration {
    ...
    private final UniVocityTsvDataFormatConfiguration configuration;
    ...
    public UniVocityTsvDataFormatAutoConfiguration(
            ...
            org.apache.camel.dataformat.univocity.springboot.UniVocityTsvDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureUniVocityTsvDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.univocity-tsv", configuration, target);
            }
            @Override
