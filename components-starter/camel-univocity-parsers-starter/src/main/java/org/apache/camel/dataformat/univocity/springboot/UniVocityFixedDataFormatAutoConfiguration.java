...
public class UniVocityFixedDataFormatAutoConfiguration {
    ...
    private final UniVocityFixedDataFormatConfiguration configuration;
    ...
    public UniVocityFixedDataFormatAutoConfiguration(
            ...
            org.apache.camel.dataformat.univocity.springboot.UniVocityFixedDataFormatConfiguration configuration) {
        ...
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.univocity-fixed", configuration, target);
            }
            @Override
