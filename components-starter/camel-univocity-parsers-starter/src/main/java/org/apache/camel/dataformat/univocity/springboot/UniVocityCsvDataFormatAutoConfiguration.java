...
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.univocity-csv"})
public class UniVocityCsvDataFormatAutoConfiguration {
    ...
    private final UniVocityCsvDataFormatConfiguration configuration;
    ...
    public UniVocityCsvDataFormatAutoConfiguration(
            ...
            org.apache.camel.dataformat.univocity.springboot.UniVocityCsvDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureUniVocityCsvDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.univocity-csv", configuration, target);
            }
            @Override
