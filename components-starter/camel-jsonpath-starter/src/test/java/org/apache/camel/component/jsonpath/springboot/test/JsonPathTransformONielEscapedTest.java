...
@DirtiesContext
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, JsonPathTransformONielEscapedTest.class,
        JsonPathTransformONielEscapedTest.TestConfiguration.class })
public class JsonPathTransformONielEscapedTest {
