...
@DirtiesContext
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, JsonPathBeanTest.class,
        JsonPathBeanTest.TestConfiguration.class })
public class JsonPathBeanTest {
    ...
    public void testFullNameTwo() throws Exception {
        ...
        mock.expectedBodiesReceived("foo foo2 bar", "bar bar2 foo");
        template.sendBody("direct:start", json);
