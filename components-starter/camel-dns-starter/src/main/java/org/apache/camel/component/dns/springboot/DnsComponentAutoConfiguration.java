...
public class DnsComponentAutoConfiguration {
    ...
    private final DnsComponentConfiguration configuration;

    public DnsComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.dns.springboot.DnsComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DnsComponent;
            }
        };
    }
}