...
public class DynamicRouterComponentAutoConfiguration {
    ...
    private final DynamicRouterComponentConfiguration configuration;

    public DynamicRouterComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.dynamicrouter.routing.springboot.DynamicRouterComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.dynamic-router", configuration, target);
            }
            @Override
