...
public class DynamicRouterControlComponentAutoConfiguration {
    ...
    private final DynamicRouterControlComponentConfiguration configuration;

    public DynamicRouterControlComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.dynamicrouter.control.springboot.DynamicRouterControlComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.dynamic-router-control", configuration, target);
            }
            @Override
