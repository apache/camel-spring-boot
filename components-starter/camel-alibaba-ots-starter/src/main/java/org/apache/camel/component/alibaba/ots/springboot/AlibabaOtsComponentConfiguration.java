 ...
 */
@ConfigurationProperties(prefix = "camel.component.alibaba-ots")
public class AlibabaOtsComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the alibaba-ots component. This
