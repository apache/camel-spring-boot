 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, TelegramComponentConverter.class})
...
public class TelegramComponentAutoConfiguration {
    ...
    private final TelegramComponentConfiguration configuration;

    public TelegramComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.telegram.springboot.TelegramComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof TelegramComponent;
            }
        };
    }
}