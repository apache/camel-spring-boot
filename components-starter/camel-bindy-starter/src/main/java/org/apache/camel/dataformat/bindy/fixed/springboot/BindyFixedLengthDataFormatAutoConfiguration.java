...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,BindyFixedLengthDataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.bindy-fixed"})
public class BindyFixedLengthDataFormatAutoConfiguration {
    ...
    private final BindyFixedLengthDataFormatConfiguration configuration;
    ...
    public BindyFixedLengthDataFormatAutoConfiguration(
            ...
            org.apache.camel.dataformat.bindy.fixed.springboot.BindyFixedLengthDataFormatConfiguration configuration) {
        ...
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.bindy-fixed", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, DataFormat target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BindyFixedLengthDataFormat;
            }
        };
    }
}