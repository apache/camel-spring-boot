...
@SpringBootTest(
    classes = {
        ...
        BindySingleQuotesWithDoubleQuotesInFieldCsvUnmarshallTest.class,
        BindySingleQuotesWithDoubleQuotesInFieldCsvUnmarshallTest.TestConfiguration.class
    }
)
public class BindySingleQuotesWithDoubleQuotesInFieldCsvUnmarshallTest {
