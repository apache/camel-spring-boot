...
@SpringBootTest(
    classes = {
        ...
        BindySimpleCsvContainingMultiQuoteCharEscapeFalseTest.class,
        BindySimpleCsvContainingMultiQuoteCharEscapeFalseTest.TestConfiguration.class
    }
)
public class BindySimpleCsvContainingMultiQuoteCharEscapeFalseTest {
    ...
    public void testMarshallCsvRecordFieldContainingMultiNonEscapedQuoteChar() throws Exception {
        ...
        mockEndPointMarshal2.assertIsSatisfied();
