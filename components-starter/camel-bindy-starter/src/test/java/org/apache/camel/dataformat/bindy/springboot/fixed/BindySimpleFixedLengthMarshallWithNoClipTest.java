...
@SpringBootTest(
    classes = {
        ...
        BindySimpleFixedLengthMarshallWithNoClipTest.class,
        BindySimpleFixedLengthMarshallWithNoClipTest.TestConfiguration.class
    }
)
public class BindySimpleFixedLengthMarshallWithNoClipTest {
