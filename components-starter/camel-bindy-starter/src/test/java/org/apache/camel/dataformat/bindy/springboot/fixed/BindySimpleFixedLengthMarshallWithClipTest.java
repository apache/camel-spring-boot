...
@SpringBootTest(
    classes = {
        ...
        BindySimpleFixedLengthMarshallWithClipTest.class,
        BindySimpleFixedLengthMarshallWithClipTest.TestConfiguration.class
    }
)
public class BindySimpleFixedLengthMarshallWithClipTest {
