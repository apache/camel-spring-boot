...
@SpringBootTest(classes = {
                           CamelAutoConfiguration.class, BindySimpleKeyValuePairFixTest.class,
                           BindySimpleKeyValuePairFixTest.TestConfiguration.class
})
                    ...
                    from("direct:fix").unmarshal(bindy).process(new Processor() {
                        ...
                        public void process(Exchange exchange) {
                            ...
                            if (order.getProduct().equals("butter")) {
                                ...
                                order.setQuantity("6");
                                body = Collections.singletonList(Collections
                                    .singletonMap(order.getClass().getName(), order));
                            }
