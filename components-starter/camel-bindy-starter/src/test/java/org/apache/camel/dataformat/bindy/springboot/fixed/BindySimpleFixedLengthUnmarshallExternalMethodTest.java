...
@SpringBootTest(
    classes = {
        ...
        BindySimpleFixedLengthUnmarshallExternalMethodTest.class,
        BindySimpleFixedLengthUnmarshallExternalMethodTest.TestConfiguration.class
    }
)
public class BindySimpleFixedLengthUnmarshallExternalMethodTest {
    ...
    public static class Order {
        ...
        @DataField(pos = 5, length = 9,
                   method = "org.apache.camel.dataformat.bindy.springboot.fixed.BindySimpleFixedLengthUnmarshallExternalMethodTest.replaceToBar")
