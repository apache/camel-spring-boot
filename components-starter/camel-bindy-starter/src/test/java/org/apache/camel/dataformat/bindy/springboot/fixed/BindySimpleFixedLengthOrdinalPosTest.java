...
@SpringBootTest(
    classes = {
        ...
        BindySimpleFixedLengthOrdinalPosTest.class,
        BindySimpleFixedLengthOrdinalPosTest.TestConfiguration.class
    }
)
public class BindySimpleFixedLengthOrdinalPosTest {
