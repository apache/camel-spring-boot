 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DebeziumOracleComponentConverter.class})
...
public class DebeziumOracleComponentAutoConfiguration {
    ...
    private final DebeziumOracleComponentConfiguration configuration;

    public DebeziumOracleComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.debezium.oracle.springboot.DebeziumOracleComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.debezium-oracle", configuration, target);
            }
            @Override
