...
public class CMComponentAutoConfiguration {
    ...
    private final CMComponentConfiguration configuration;

    public CMComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.cm.springboot.CMComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.cm-sms", configuration, target);
            }
            @Override
