 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, AWS2EC2ComponentConverter.class})
...
public class AWS2EC2ComponentAutoConfiguration {
    ...
    private final AWS2EC2ComponentConfiguration configuration;

    public AWS2EC2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.ec2.springboot.AWS2EC2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-ec2", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof AWS2EC2Component;
            }
        };
    }
}