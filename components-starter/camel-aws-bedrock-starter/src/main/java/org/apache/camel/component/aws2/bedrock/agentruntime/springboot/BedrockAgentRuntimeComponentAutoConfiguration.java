 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, BedrockAgentRuntimeComponentConverter.class})
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.aws-bedrock-agent-runtime"})
public class BedrockAgentRuntimeComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final BedrockAgentRuntimeComponentConfiguration configuration;

    public BedrockAgentRuntimeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.bedrock.agentruntime.springboot.BedrockAgentRuntimeComponentConfiguration configuration) {
