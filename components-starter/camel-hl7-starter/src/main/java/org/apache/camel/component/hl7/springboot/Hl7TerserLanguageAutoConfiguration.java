...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,Hl7TerserLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.hl7terser"})
public class Hl7TerserLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final CamelContext camelContext;
    private final Hl7TerserLanguageConfiguration configuration;

    public Hl7TerserLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.CamelContext camelContext,
            org.apache.camel.component.hl7.springboot.Hl7TerserLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureHl7TerserLanguage() {
