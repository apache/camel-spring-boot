...
public class DisruptorComponentAutoConfiguration {
    ...
    private final DisruptorComponentConfiguration configuration;

    public DisruptorComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.disruptor.springboot.DisruptorComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DisruptorComponent;
            }
        };
    }
}