 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, ConsulComponentConverter.class})
...
public class ConsulComponentAutoConfiguration {
    ...
    private final ConsulComponentConfiguration configuration;

    public ConsulComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.consul.springboot.ConsulComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.consul", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof ConsulComponent;
            }
        };
    }
}