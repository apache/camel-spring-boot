 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, STS2ComponentConverter.class})
...
public class STS2ComponentAutoConfiguration {
    ...
    private final STS2ComponentConfiguration configuration;

    public STS2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.sts.springboot.STS2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-sts", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof STS2Component;
            }
        };
    }
}