 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DebeziumSqlserverComponentConverter.class})
...
public class DebeziumSqlserverComponentAutoConfiguration {
    ...
    private final DebeziumSqlserverComponentConfiguration configuration;

    public DebeziumSqlserverComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.debezium.sqlserver.springboot.DebeziumSqlserverComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.debezium-sqlserver", configuration, target);
            }
            @Override
