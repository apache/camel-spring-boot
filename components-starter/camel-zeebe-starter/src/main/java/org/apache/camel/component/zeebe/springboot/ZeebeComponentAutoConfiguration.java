...
public class ZeebeComponentAutoConfiguration {
    ...
    private final ZeebeComponentConfiguration configuration;

    public ZeebeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.zeebe.springboot.ZeebeComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.zeebe", configuration, target);
            }
            @Override
