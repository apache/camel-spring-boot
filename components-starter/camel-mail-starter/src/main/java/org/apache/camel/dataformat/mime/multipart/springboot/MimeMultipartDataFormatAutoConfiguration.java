...
public class MimeMultipartDataFormatAutoConfiguration {
    ...
    private final MimeMultipartDataFormatConfiguration configuration;
    ...
    public MimeMultipartDataFormatAutoConfiguration(
            ...
            org.apache.camel.dataformat.mime.multipart.springboot.MimeMultipartDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureMimeMultipartDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.mime-multipart", configuration, target);
            }
            @Override
