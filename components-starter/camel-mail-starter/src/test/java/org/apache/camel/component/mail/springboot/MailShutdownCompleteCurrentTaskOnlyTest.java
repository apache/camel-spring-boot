...
@SpringBootTest(
    classes = {
        ...
        MailShutdownCompleteCurrentTaskOnlyTest.class,
        MailShutdownCompleteCurrentTaskOnlyTest.TestConfiguration.class
    }
)
public class MailShutdownCompleteCurrentTaskOnlyTest {
