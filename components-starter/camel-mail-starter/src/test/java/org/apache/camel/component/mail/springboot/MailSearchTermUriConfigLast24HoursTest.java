...
@SpringBootTest(
    classes = {
        ...
        MailSearchTermUriConfigLast24HoursTest.class,
        MailSearchTermUriConfigLast24HoursTest.TestConfiguration.class
    }
)
public class MailSearchTermUriConfigLast24HoursTest {
