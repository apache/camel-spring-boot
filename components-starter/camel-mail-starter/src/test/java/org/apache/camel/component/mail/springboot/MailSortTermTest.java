...
@SpringBootTest(
    classes = {
        ...
        MailSortTermTest.class,
        MailSortTermTest.TestConfiguration.class
    }
)
public class MailSortTermTest {
    ...
    @EndpointInject("mock:resultAscending")
    MockEndpoint mockAsc;
    
    @Bean("sortAscendingDate")
    private SortTerm[] getAscTerm() {
        return new SortTerm[] { SortTerm.DATE };
    }

    @Bean("sortDescendingDate")
    private SortTerm[] getDescTerm() {
