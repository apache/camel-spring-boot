 ...
 */
@ConfigurationProperties(prefix = "camel.component.alibaba-oss")
public class OSSComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the alibaba-oss component. This
