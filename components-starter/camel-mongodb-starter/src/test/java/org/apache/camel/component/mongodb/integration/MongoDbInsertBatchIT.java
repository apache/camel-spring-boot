...
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, MongoDbInsertBatchIT.class,
        MongoDbInsertBatchIT.TestConfiguration.class, AbstractMongoDbITSupport.MongoConfiguration.class })
...
public class MongoDbInsertBatchIT extends AbstractMongoDbITSupport {
    ...
    public void testInsertBatch() {
        ...
        Exchange out = context.createFluentProducerTemplate().to("direct:insert").withBody(taxGroupList).send();
