 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, HazelcastPNCounterComponentConverter.class})
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.hazelcast-pncounter"})
public class HazelcastPNCounterComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final HazelcastPNCounterComponentConfiguration configuration;

    public HazelcastPNCounterComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.hazelcast.pncounter.springboot.HazelcastPNCounterComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.hazelcast-pncounter", configuration, target);
            }
            @Override
