 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, HazelcastAtomicnumberComponentConverter.class})
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.hazelcast-atomicvalue"})
public class HazelcastAtomicnumberComponentAutoConfiguration {
    ...
    public HazelcastAtomicnumberComponentAutoConfiguration(
            ...
            org.apache.camel.component.hazelcast.atomicnumber.springboot.HazelcastAtomicnumberComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.hazelcast-atomicvalue", configuration, target);
            }
            @Override
