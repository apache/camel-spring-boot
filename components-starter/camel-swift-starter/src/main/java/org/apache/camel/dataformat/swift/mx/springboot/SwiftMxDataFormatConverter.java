...
public class SwiftMxDataFormatConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
        ...
        answer.add(new ConvertiblePair(String.class, com.prowidesoftware.swift.model.MxId.class));
        answer.add(new ConvertiblePair(String.class, com.prowidesoftware.swift.model.mx.MxReadConfiguration.class));
        answer.add(new ConvertiblePair(String.class, com.prowidesoftware.swift.model.mx.MxWriteConfiguration.class));
        return answer;
    }
