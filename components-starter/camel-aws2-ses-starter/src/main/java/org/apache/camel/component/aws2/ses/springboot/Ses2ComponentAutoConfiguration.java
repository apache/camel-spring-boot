 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Ses2ComponentConverter.class})
...
public class Ses2ComponentAutoConfiguration {
    ...
    private final Ses2ComponentConfiguration configuration;

    public Ses2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.ses.springboot.Ses2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-ses", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Ses2Component;
            }
        };
    }
}