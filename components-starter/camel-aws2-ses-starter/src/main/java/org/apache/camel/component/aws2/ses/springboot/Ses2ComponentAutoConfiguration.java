...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        Ses2ComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        Ses2ComponentConfiguration.class})
public class Ses2ComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(Ses2ComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<Ses2Component>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.aws2-ses");
        }
    }
