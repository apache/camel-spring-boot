...
public class ThymeleafComponentAutoConfiguration {
    ...
    private final ThymeleafComponentConfiguration configuration;

    public ThymeleafComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.thymeleaf.springboot.ThymeleafComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.thymeleaf", configuration, target);
            }
            @Override
