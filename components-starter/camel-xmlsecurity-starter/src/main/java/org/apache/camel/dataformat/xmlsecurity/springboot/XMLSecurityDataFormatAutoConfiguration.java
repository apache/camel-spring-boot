...
public class XMLSecurityDataFormatAutoConfiguration {
    ...
    private final XMLSecurityDataFormatConfiguration configuration;

    public XMLSecurityDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.dataformat.xmlsecurity.springboot.XMLSecurityDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureXMLSecurityDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.xml-security", configuration, target);
            }
            @Override
