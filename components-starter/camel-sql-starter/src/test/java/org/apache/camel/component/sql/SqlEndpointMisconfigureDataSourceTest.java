...
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, SqlEndpointMisconfigureDataSourceTest.class,
        SqlEndpointMisconfigureDataSourceTest.TestConfiguration.class, BaseSql.TestConfiguration.class })
