...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        ReactiveStreamsComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        ReactiveStreamsComponentConfiguration.class})
public class ReactiveStreamsComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ReactiveStreamsComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<ReactiveStreamsComponent>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.reactive-streams");
        }
    }
