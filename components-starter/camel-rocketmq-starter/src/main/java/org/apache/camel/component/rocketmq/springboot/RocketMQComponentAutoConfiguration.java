...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.rocketmq"})
public class RocketMQComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final RocketMQComponentConfiguration configuration;

    public RocketMQComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.rocketmq.springboot.RocketMQComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.rocketmq", configuration, target);
            }
            @Override
