...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,SnmpComponentConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.snmp"})
public class SnmpComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final SnmpComponentConfiguration configuration;

    public SnmpComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.snmp.springboot.SnmpComponentConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureSnmpComponent() {
