 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, EKS2ComponentConverter.class})
...
public class EKS2ComponentAutoConfiguration {
    ...
    private final EKS2ComponentConfiguration configuration;

    public EKS2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.eks.springboot.EKS2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-eks", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof EKS2Component;
            }
        };
    }
}