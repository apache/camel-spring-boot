...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        EKS2ComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        EKS2ComponentConfiguration.class})
public class EKS2ComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(EKS2ComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<EKS2Component>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.aws2-eks");
        }
    }
