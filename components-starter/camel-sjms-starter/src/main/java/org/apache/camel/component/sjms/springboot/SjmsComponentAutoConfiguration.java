 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, SjmsComponentConverter.class})
...
public class SjmsComponentAutoConfiguration {
    ...
    private final SjmsComponentConfiguration configuration;

    public SjmsComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.sjms.springboot.SjmsComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.sjms", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof SjmsComponent;
            }
        };
    }
}