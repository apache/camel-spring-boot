...
@Component
public class Neo4jComponentConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
        ...
        answer.add(new ConvertiblePair(String.class, org.apache.camel.component.neo4j.Neo4jConfiguration.class));
        answer.add(new ConvertiblePair(String.class, org.neo4j.driver.Driver.class));
        return answer;
    }
