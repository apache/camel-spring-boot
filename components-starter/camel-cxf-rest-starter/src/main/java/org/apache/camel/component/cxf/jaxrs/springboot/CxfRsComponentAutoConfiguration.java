 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CxfRsComponentConverter.class})
...
public class CxfRsComponentAutoConfiguration {
    ...
    private final CxfRsComponentConfiguration configuration;

    public CxfRsComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.cxf.jaxrs.springboot.CxfRsComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof CxfRsComponent;
            }
        };
    }
}