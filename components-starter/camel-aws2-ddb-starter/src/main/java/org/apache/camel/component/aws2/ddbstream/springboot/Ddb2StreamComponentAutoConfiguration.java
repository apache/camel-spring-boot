 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Ddb2StreamComponentConverter.class})
...
public class Ddb2StreamComponentAutoConfiguration {
    ...
    private final Ddb2StreamComponentConfiguration configuration;

    public Ddb2StreamComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.ddbstream.springboot.Ddb2StreamComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-ddbstream", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Ddb2StreamComponent;
            }
        };
    }
}