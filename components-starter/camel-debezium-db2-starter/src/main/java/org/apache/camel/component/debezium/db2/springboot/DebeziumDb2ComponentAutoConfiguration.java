 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DebeziumDb2ComponentConverter.class})
...
public class DebeziumDb2ComponentAutoConfiguration {
    ...
    private final DebeziumDb2ComponentConfiguration configuration;

    public DebeziumDb2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.debezium.db2.springboot.DebeziumDb2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.debezium-db2", configuration, target);
            }
            @Override
