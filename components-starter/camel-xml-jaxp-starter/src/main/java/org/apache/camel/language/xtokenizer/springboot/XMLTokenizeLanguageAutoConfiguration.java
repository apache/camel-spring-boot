...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        XMLTokenizeLanguageAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({LanguageConfigurationProperties.class,
        XMLTokenizeLanguageConfiguration.class})
public class XMLTokenizeLanguageAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(XMLTokenizeLanguageAutoConfiguration.class);
    @Autowired
    ...
    private List<LanguageCustomizer<XMLTokenizeLanguage>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.xtokenize");
        }
    }
