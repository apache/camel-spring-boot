...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,SpelLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.spel"})
public class SpelLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final SpelLanguageConfiguration configuration;

    public SpelLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.spel.springboot.SpelLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureSpelLanguage() {
