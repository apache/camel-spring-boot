...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,OgnlLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.ognl"})
public class OgnlLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final OgnlLanguageConfiguration configuration;

    public OgnlLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.ognl.springboot.OgnlLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureOgnlLanguage() {
        return new LanguageCustomizer() {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof OgnlLanguage;
            }
        };
    }
}