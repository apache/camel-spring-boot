...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,XMLTokenizeLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.xtokenize"})
public class XMLTokenizeLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final XMLTokenizeLanguageConfiguration configuration;

    public XMLTokenizeLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.xtokenizer.springboot.XMLTokenizeLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureXMLTokenizeLanguage() {
