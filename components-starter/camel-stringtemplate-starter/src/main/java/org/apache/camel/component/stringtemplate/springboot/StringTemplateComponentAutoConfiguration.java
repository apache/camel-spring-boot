...
public class StringTemplateComponentAutoConfiguration {
    ...
    private final StringTemplateComponentConfiguration configuration;

    public StringTemplateComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.stringtemplate.springboot.StringTemplateComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.string-template", configuration, target);
            }
            @Override
