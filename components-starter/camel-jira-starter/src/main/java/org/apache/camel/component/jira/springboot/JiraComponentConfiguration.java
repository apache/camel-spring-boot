...
public class JiraComponentConfiguration
    ...
    /**
     * To use a shared base jira configuration. The option is a
     * org.apache.camel.component.jira.JiraConfiguration type.
     */
     ...
     * server. Use only if OAuth is not enabled on the Jira server. Do not set
     * the username and OAuth token parameter, if they are both set, the
     * username basic authentication takes precedence.
     */
    private String username;
    /**
     * (OAuth only) The verification code from Jira generated in the first step
     * of the authorization proccess.
     */
