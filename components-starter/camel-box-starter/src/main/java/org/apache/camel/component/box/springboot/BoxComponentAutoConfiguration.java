 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, BoxComponentConverter.class})
...
public class BoxComponentAutoConfiguration {
    ...
    private final BoxComponentConfiguration configuration;

    public BoxComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.box.springboot.BoxComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.box", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BoxComponent;
            }
        };
    }
}