...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,XQueryLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.xquery"})
public class XQueryLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final XQueryLanguageConfiguration configuration;

    public XQueryLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.xquery.springboot.XQueryLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureXQueryLanguage() {
