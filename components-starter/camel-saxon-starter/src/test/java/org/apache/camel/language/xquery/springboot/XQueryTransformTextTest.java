...
@DirtiesContext
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, XQueryTransformTextTest.class,
        XQueryTransformTextTest.TestConfiguration.class })
public class XQueryTransformTextTest {
