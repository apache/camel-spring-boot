 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DataSetComponentConverter.class})
...
public class DataSetComponentAutoConfiguration {
    ...
    private final DataSetComponentConfiguration configuration;

    public DataSetComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.dataset.springboot.DataSetComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DataSetComponent;
            }
        };
    }
}