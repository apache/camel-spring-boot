...
:page-partial:
:doctitle: Camel Spring Boot Starter for huaweicloud-dms

== Spring Boot Auto-Configuration

When using huaweicloud-dms with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
