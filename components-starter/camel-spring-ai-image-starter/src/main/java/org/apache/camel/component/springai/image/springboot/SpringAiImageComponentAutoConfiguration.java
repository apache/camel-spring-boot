 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, SpringAiImageComponentConverter.class})
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.spring-ai-image"})
public class SpringAiImageComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final SpringAiImageComponentConfiguration configuration;

    public SpringAiImageComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.springai.image.springboot.SpringAiImageComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.spring-ai-image", configuration, target);
            }
            @Override
