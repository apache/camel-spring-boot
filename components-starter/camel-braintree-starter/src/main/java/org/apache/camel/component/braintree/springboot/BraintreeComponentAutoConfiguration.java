 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, BraintreeComponentConverter.class})
...
public class BraintreeComponentAutoConfiguration {
    ...
    private final BraintreeComponentConfiguration configuration;

    public BraintreeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.braintree.springboot.BraintreeComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.braintree", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BraintreeComponent;
            }
        };
    }
}