...
@SpringBootTest(classes = {CamelAutoConfiguration.class, JolokiaComponentAutoConfiguration.class},
		properties = {"camel.component.jolokia.serverConfig.port=0",
				"camel.component.jolokia.useCamelRestrictor=false"})
public class JolokiaComponentAutoConfigurationWithoutRestrictorTest extends JolokiaComponentTestBase {
	...
	void checkConfigurationTest() {
		...
		Assertions.assertThat(agent)
				...
				.doesNotContainKey(ConfigKey.RESTRICTOR_CLASS.getKeyValue());
