...
@SpringBootTest(classes = {JolokiaComponentAutoConfigurationPrefersPropertiesTest.TestConfiguration.class, CamelAutoConfiguration.class, JolokiaComponentAutoConfiguration.class},
		properties = {"camel.component.jolokia.serverConfig.port=0", "logging.level.org.apache.camel.component.jolokia=TRACE"})
public class JolokiaComponentAutoConfigurationPrefersPropertiesTest extends JolokiaComponentTestBase {

	@Test
	void checkPortIsRandomTest() {
		assertThat(agent.getAddress().getPort())
				.describedAs("check the value from custom bean does not override the properties")
				.isNotZero()
				.isNotEqualTo(8778);
	}
	...
	public static class TestConfiguration {
		...
		public SpringJolokiaConfigHolder configHolder() {
			...
			myConfig.setConfig(Map.of("port", "8778"));
			return myConfig;
		}
	}
}
