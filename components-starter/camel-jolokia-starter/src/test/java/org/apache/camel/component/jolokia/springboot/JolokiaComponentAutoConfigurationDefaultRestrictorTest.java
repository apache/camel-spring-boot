...
public class JolokiaComponentAutoConfigurationDefaultRestrictorTest extends JolokiaComponentTestBase {
	...
	void checkConfigurationTest() {
		...
		Assertions.assertThat(agent.getServerConfig().getJolokiaConfig().getConfig(ConfigKey.RESTRICTOR_CLASS))
				.as("check the jolokia config")
				.isEqualTo("org.apache.camel.component.jolokia.springboot.restrictor.CamelRestrictor");
	}
}
