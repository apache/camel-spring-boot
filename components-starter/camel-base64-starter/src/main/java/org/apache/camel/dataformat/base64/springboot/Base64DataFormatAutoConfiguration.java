...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,Base64DataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.base64"})
public class Base64DataFormatAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final ObjectProvider<CamelContext> camelContextProvider;
    private final Base64DataFormatConfiguration configuration;

    public Base64DataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.dataformat.base64.springboot.Base64DataFormatConfiguration configuration) {
        ...
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.base64", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, DataFormat target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Base64DataFormat;
            }
        };
    }
}