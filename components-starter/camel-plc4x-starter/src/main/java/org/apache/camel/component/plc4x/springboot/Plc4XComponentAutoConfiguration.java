 ...
 */
package org.apache.camel.component.plc4x.springboot;
...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,Plc4XComponentConfiguration.class})
...
public class Plc4XComponentAutoConfiguration {
    ...
    @Autowired
    private Plc4XComponentConfiguration configuration;
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configurePlc4XComponent() {
