...
public class JsonValidatorComponentAutoConfiguration {
    ...
    private final JsonValidatorComponentConfiguration configuration;

    public JsonValidatorComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.jsonvalidator.springboot.JsonValidatorComponentConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureJsonValidatorComponent() {
        return new ComponentCustomizer() {
            @Override
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.json-validator", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof JsonValidatorComponent;
            }
        };
    }
}