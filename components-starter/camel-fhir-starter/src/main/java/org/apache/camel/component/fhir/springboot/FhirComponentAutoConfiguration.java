 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, FhirComponentConverter.class})
...
public class FhirComponentAutoConfiguration {
    ...
    private final FhirComponentConfiguration configuration;

    public FhirComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.fhir.springboot.FhirComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof FhirComponent;
            }
        };
    }
}