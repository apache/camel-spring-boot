...
public class FhirXmlDataFormatAutoConfiguration {
    ...
    private final FhirXmlDataFormatConfiguration configuration;

    public FhirXmlDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.component.fhir.springboot.FhirXmlDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureFhirXmlDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.fhir-xml", configuration, target);
            }
            @Override
