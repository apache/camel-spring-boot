 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CometdComponentConverter.class})
...
public class CometdComponentAutoConfiguration {
    ...
    private final CometdComponentConfiguration configuration;

    public CometdComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.cometd.springboot.CometdComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.cometd", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof CometdComponent;
            }
        };
    }
}