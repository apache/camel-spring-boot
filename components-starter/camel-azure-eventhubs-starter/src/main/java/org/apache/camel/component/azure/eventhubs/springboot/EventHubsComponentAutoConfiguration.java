 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, EventHubsComponentConverter.class})
...
public class EventHubsComponentAutoConfiguration {
    ...
    private final EventHubsComponentConfiguration configuration;

    public EventHubsComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.azure.eventhubs.springboot.EventHubsComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.azure-eventhubs", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof EventHubsComponent;
            }
        };
    }
}