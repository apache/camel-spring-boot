 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, BeanValidatorComponentConverter.class})
...
public class BeanValidatorComponentAutoConfiguration {
    ...
    private final BeanValidatorComponentConfiguration configuration;

    public BeanValidatorComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.bean.validator.springboot.BeanValidatorComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.bean-validator", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BeanValidatorComponent;
            }
        };
    }
}