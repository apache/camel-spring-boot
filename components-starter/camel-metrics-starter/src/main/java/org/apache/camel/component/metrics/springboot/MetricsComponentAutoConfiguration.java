...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        MetricsComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        MetricsComponentConfiguration.class})
public class MetricsComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(MetricsComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<MetricsComponent>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.metrics");
        }
    }
