...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,JavaScriptLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.js"})
public class JavaScriptLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final JavaScriptLanguageConfiguration configuration;

    public JavaScriptLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.js.springboot.JavaScriptLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureJavaScriptLanguage() {
