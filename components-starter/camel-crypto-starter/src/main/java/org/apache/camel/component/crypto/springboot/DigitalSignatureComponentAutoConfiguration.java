...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        DigitalSignatureComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        DigitalSignatureComponentConfiguration.class})
public class DigitalSignatureComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(DigitalSignatureComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<DigitalSignatureComponent>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.crypto");
        }
    }
    ...
    public DigitalSignatureComponent configureDigitalSignatureComponent()
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<DigitalSignatureComponent> customizer : customizers) {
