 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, ServiceNowComponentConverter.class})
@Conditional(ConditionalOnCamelContextAndAutoConfigurationBeans.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,ServiceNowComponentConfiguration.class})
...
public class ServiceNowComponentAutoConfiguration {
    ...
    @Lazy
    @Bean
    public ComponentCustomizer configureServiceNowComponent() {
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof ServiceNowComponent;
            }
        };
    }
}