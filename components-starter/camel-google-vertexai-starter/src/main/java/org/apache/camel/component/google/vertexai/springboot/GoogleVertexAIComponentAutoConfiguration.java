 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, GoogleVertexAIComponentConverter.class})
...
public class GoogleVertexAIComponentAutoConfiguration {
    ...
    private final GoogleVertexAIComponentConfiguration configuration;

    public GoogleVertexAIComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.google.vertexai.springboot.GoogleVertexAIComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.google-vertexai", configuration, target);
            }
            @Override
