...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,SyslogDataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.syslog"})
public class SyslogDataFormatAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final ObjectProvider<CamelContext> camelContextProvider;
    private final SyslogDataFormatConfiguration configuration;

    public SyslogDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.component.syslog.springboot.SyslogDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureSyslogDataFormatFactory() {
