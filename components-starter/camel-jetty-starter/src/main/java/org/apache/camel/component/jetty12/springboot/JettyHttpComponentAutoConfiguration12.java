 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, JettyHttpComponentConverter12.class})
...
public class JettyHttpComponentAutoConfiguration12 {
    ...
    private final JettyHttpComponentConfiguration12 configuration;

    public JettyHttpComponentAutoConfiguration12(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.jetty12.springboot.JettyHttpComponentConfiguration12 configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.jetty", configuration, target);
            }
            @Override
