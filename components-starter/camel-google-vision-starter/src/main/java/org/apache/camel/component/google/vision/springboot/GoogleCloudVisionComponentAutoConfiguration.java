...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.google-vision"})
public class GoogleCloudVisionComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final GoogleCloudVisionComponentConfiguration configuration;

    public GoogleCloudVisionComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.google.vision.springboot.GoogleCloudVisionComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.google-vision", configuration, target);
            }
            @Override
