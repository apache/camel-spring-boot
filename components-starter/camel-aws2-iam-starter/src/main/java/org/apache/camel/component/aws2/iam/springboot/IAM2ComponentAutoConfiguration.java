 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, IAM2ComponentConverter.class})
...
public class IAM2ComponentAutoConfiguration {
    ...
    private final IAM2ComponentConfiguration configuration;

    public IAM2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.iam.springboot.IAM2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-iam", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof IAM2Component;
            }
        };
    }
}