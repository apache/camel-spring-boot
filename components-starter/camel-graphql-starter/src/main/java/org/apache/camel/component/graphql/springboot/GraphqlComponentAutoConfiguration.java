 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, GraphqlComponentConverter.class})
...
public class GraphqlComponentAutoConfiguration {
    ...
    private final GraphqlComponentConfiguration configuration;

    public GraphqlComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.graphql.springboot.GraphqlComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof GraphqlComponent;
            }
        };
    }
}