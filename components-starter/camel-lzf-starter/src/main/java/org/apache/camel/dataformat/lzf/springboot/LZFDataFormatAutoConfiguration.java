...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,LZFDataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.lzf"})
public class LZFDataFormatAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final ObjectProvider<CamelContext> camelContextProvider;
    private final LZFDataFormatConfiguration configuration;

    public LZFDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.dataformat.lzf.springboot.LZFDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureLZFDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.lzf", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, DataFormat target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof LZFDataFormat;
            }
        };
    }
}