...
@Component
public class DaprComponentConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
        ...
        answer.add(new ConvertiblePair(String.class, io.dapr.client.DaprClient.class));
        ...
        answer.add(new ConvertiblePair(String.class, io.dapr.workflows.client.DaprWorkflowClient.class));
        return answer;
    }
    ...
    public Object convert(
        ...
        switch (targetType.getName()) {
            case "io.dapr.client.DaprClient": return applicationContext.getBean(ref, io.dapr.client.DaprClient.class);
            ...
            case "io.dapr.workflows.client.DaprWorkflowClient": return applicationContext.getBean(ref, io.dapr.workflows.client.DaprWorkflowClient.class);
        }
        return null;
    }
}