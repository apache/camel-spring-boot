...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,TypeSafeAiLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.typesafe-ai"})
public class TypeSafeAiLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final TypeSafeAiLanguageConfiguration configuration;

    public TypeSafeAiLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.typesafeai.springboot.TypeSafeAiLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureTypeSafeAiLanguage() {
        return new LanguageCustomizer() {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.typesafe-ai", configuration, target);
                } else {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                        ...
                        "camel.language.typesafe-ai.customizer")
                    && target instanceof TypeSafeAiLanguage;
            }
        };
    }
}
