...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,RefLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.ref"})
