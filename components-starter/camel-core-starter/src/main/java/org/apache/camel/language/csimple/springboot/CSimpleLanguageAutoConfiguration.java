...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,CSimpleLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.csimple"})
public class CSimpleLanguageAutoConfiguration {
    ...
    @Autowired
    private CSimpleLanguageConfiguration configuration;
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureCSimpleLanguage() {
        return new LanguageCustomizer() {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                        ...
                        "camel.language.csimple.customizer")
                    && target instanceof CSimpleLanguage;
            }
        };
    }
}