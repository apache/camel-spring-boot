...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,SimpleLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.simple"})
public class SimpleLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final SimpleLanguageConfiguration configuration;

    public SimpleLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.simple.springboot.SimpleLanguageConfiguration configuration) {
