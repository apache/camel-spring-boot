...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,VariableLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.variable"})
public class VariableLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final VariableLanguageConfiguration configuration;

    public VariableLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.variable.springboot.VariableLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureVariableLanguage() {
        return new LanguageCustomizer() {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.variable", configuration, target);
                } else {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                        ...
                        "camel.language.variable.customizer")
                    && target instanceof VariableLanguage;
            }
        };
    }
}