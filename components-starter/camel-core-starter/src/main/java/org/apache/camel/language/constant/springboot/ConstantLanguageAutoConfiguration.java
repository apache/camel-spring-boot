...
public class ConstantLanguageAutoConfiguration {
    ...
    private final ConstantLanguageConfiguration configuration;

    public ConstantLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.constant.springboot.ConstantLanguageConfiguration configuration) {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.constant", configuration, target);
                } else {
