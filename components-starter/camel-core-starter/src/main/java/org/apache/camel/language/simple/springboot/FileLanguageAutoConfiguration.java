...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        FileLanguageAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({LanguageConfigurationProperties.class,
        FileLanguageConfiguration.class})
public class FileLanguageAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(FileLanguageAutoConfiguration.class);
    @Autowired
    ...
    private List<LanguageCustomizer<FileLanguage>> customizers;
