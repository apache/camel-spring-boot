...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,FileLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.file"})
public class FileLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final CamelContext camelContext;
    private final FileLanguageConfiguration configuration;

    public FileLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.CamelContext camelContext,
            org.apache.camel.language.simple.springboot.FileLanguageConfiguration configuration) {
