 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, MSK2ComponentConverter.class})
...
public class MSK2ComponentAutoConfiguration {
    ...
    private final MSK2ComponentConfiguration configuration;

    public MSK2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.msk.springboot.MSK2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-msk", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof MSK2Component;
            }
        };
    }
}