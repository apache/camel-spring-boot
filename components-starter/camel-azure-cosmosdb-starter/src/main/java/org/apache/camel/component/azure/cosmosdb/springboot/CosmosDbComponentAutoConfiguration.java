 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CosmosDbComponentConverter.class})
...
public class CosmosDbComponentAutoConfiguration {
    ...
    private final CosmosDbComponentConfiguration configuration;

    public CosmosDbComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.azure.cosmosdb.springboot.CosmosDbComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.azure-cosmosdb", configuration, target);
            }
            @Override
