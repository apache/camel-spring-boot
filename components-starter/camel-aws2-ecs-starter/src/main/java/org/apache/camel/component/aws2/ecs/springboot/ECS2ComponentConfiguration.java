...
public class ECS2ComponentConfiguration
    ...
    /**
     * To use an existing configured AWS ECS client. The option is a
    ...
    /**
     * Set whether the ECS client should expect to use Session Credentials. This
     * is useful in a situation in which the user needs to assume an IAM role
     * for doing operations in ECS.
     */
