 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, ECS2ComponentConverter.class})
...
public class ECS2ComponentAutoConfiguration {
    ...
    private final ECS2ComponentConfiguration configuration;

    public ECS2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.ecs.springboot.ECS2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-ecs", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof ECS2Component;
            }
        };
    }
}