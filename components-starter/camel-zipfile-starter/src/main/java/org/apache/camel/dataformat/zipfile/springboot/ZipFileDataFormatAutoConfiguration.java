...
public class ZipFileDataFormatAutoConfiguration {
    ...
    private final ZipFileDataFormatConfiguration configuration;

    public ZipFileDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.dataformat.zipfile.springboot.ZipFileDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureZipFileDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.zip-file", configuration, target);
            }
            @Override
