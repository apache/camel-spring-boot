...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,BeanLanguageConfiguration.class})
...
public class BeanLanguageAutoConfiguration {
    ...
    private final BeanLanguageConfiguration configuration;

    public BeanLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.bean.springboot.BeanLanguageConfiguration configuration) {
        ...
        return new LanguageCustomizer() {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.bean", configuration, target);
                } else {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BeanLanguage;
            }
        };
    }
}