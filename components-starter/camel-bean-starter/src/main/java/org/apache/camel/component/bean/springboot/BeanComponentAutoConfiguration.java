...
public class BeanComponentAutoConfiguration {
    ...
    private final BeanComponentConfiguration configuration;

    public BeanComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.bean.springboot.BeanComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.bean", configuration, target);
            }
            @Override
