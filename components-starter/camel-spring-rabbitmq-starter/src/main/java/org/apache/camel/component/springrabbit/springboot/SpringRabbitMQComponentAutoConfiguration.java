 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, SpringRabbitMQComponentConverter.class})
...
public class SpringRabbitMQComponentAutoConfiguration {
    ...
    private final SpringRabbitMQComponentConfiguration configuration;

    public SpringRabbitMQComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.springrabbit.springboot.SpringRabbitMQComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.spring-rabbitmq", configuration, target);
            }
            @Override
