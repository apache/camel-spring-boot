...
@Component
public class SpringRabbitMQComponentConverter implements GenericConverter {
    ...
    public Set<ConvertiblePair> getConvertibleTypes() {
        ...
        answer.add(new ConvertiblePair(String.class, org.springframework.amqp.rabbit.config.StatelessRetryOperationsInterceptor.class));
