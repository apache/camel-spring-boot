 ...
 */
@ConfigurationProperties(prefix = "camel.component.pgvector")
public class PgVectorComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the pgvector component. This is
     * enabled by default.
     */
    private Boolean enabled;
    /**
     * The configuration;. The option is a
     * org.apache.camel.component.pgvector.PgVectorConfiguration type.
     */
    private PgVectorConfiguration configuration;
    /**
     * The DataSource to use for connecting to the PostgreSQL database with
     * pgvector extension. The option is a javax.sql.DataSource type.
     */
