...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.google-speech-to-text"})
public class GoogleCloudSpeechToTextComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final GoogleCloudSpeechToTextComponentConfiguration configuration;

    public GoogleCloudSpeechToTextComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.google.speechtotext.springboot.GoogleCloudSpeechToTextComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.google-speech-to-text", configuration, target);
            }
            @Override
