 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, TahuEdgeComponentConverter.class})
...
public class TahuEdgeComponentAutoConfiguration {
    ...
    private final TahuEdgeComponentConfiguration configuration;

    public TahuEdgeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.tahu.springboot.TahuEdgeComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.tahu-edge", configuration, target);
            }
            @Override
