 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, KubernetesCronJobComponentConverter.class})
...
public class KubernetesCronJobComponentAutoConfiguration {
    ...
    private final KubernetesCronJobComponentConfiguration configuration;

    public KubernetesCronJobComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.kubernetes.cronjob.springboot.KubernetesCronJobComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.kubernetes-cronjob", configuration, target);
            }
            @Override
