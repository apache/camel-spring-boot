 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, KubernetesNodesComponentConverter.class})
...
public class KubernetesNodesComponentAutoConfiguration {
    ...
    private final KubernetesNodesComponentConfiguration configuration;

    public KubernetesNodesComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.kubernetes.nodes.springboot.KubernetesNodesComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.kubernetes-nodes", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof KubernetesNodesComponent;
            }
        };
    }
}