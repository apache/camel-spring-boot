...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        KubernetesConfigMapsComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        KubernetesConfigMapsComponentConfiguration.class})
public class KubernetesConfigMapsComponentAutoConfiguration {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(KubernetesConfigMapsComponentAutoConfiguration.class);
    @Autowired
    ...
    private List<ComponentCustomizer<KubernetesConfigMapsComponent>> customizers;

    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.kubernetes-config-maps");
        }
    }
