 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, OpenshiftDeploymentConfigsComponentConverter.class})
...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.openshift-deploymentconfigs"})
public class OpenshiftDeploymentConfigsComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final OpenshiftDeploymentConfigsComponentConfiguration configuration;

    public OpenshiftDeploymentConfigsComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.openshift.deploymentconfigs.springboot.OpenshiftDeploymentConfigsComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.openshift-deploymentconfigs", configuration, target);
            }
            @Override
