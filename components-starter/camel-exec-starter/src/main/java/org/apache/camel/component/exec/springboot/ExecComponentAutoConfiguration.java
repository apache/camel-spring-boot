 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, ExecComponentConverter.class})
...
public class ExecComponentAutoConfiguration {
    ...
    private final ExecComponentConfiguration configuration;

    public ExecComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.exec.springboot.ExecComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                        ...
                        "camel.component.exec.customizer")
                    && target instanceof ExecComponent;
            }
        };
    }
}