...
public class ExecComponentConfiguration
     ...
     * CamelExecCommandWorkingDir, CamelExecCommandTimeout, CamelExecExitValues,
     * CamelExecUseStderrOnEmptyStdout, and CamelExecCommandLogLevel are
     * ignored. Enable only when those headers come from a trusted route, not
