 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Sjms2ComponentConverter.class})
...
public class Sjms2ComponentAutoConfiguration {
    ...
    private final Sjms2ComponentConfiguration configuration;

    public Sjms2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.sjms2.springboot.Sjms2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.sjms2", configuration, target);
            }
            @Override
