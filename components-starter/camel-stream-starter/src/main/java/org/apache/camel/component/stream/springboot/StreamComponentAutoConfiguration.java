...
@EnableConfigurationProperties({ComponentConfigurationProperties.class,StreamComponentConfiguration.class})
...
public class StreamComponentAutoConfiguration {
    ...
    private final StreamComponentConfiguration configuration;

    public StreamComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.stream.springboot.StreamComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof StreamComponent;
            }
        };
    }
}