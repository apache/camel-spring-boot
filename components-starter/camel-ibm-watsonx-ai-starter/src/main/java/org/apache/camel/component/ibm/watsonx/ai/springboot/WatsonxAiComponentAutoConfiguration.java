 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, WatsonxAiComponentConverter.class})
@Conditional(ConditionalOnCamelContextAndAutoConfigurationBeans.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,WatsonxAiComponentConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.ibm-watsonx-ai"})
public class WatsonxAiComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final WatsonxAiComponentConfiguration configuration;

    public WatsonxAiComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.ibm.watsonx.ai.springboot.WatsonxAiComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.ibm-watsonx-ai", configuration, target);
            }
            @Override
