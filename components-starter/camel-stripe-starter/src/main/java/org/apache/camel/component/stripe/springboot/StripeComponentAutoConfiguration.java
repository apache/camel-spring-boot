...
public class StripeComponentAutoConfiguration {
    ...
    private final StripeComponentConfiguration configuration;

    public StripeComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.stripe.springboot.StripeComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.stripe", configuration, target);
            }
            @Override
