...
@EnableConfigurationProperties({DataFormatConfigurationProperties.class,JaxbDataFormatConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.jaxb"})
public class JaxbDataFormatAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final ObjectProvider<CamelContext> camelContextProvider;
    private final JaxbDataFormatConfiguration configuration;

    public JaxbDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.converter.jaxb.springboot.JaxbDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureJaxbDataFormatFactory() {
