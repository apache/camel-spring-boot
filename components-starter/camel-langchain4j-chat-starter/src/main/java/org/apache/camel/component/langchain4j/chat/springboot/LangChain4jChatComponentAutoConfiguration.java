 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, LangChain4jChatComponentConverter.class})
...
public class LangChain4jChatComponentAutoConfiguration {
    ...
    private final LangChain4jChatComponentConfiguration configuration;

    public LangChain4jChatComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.langchain4j.chat.springboot.LangChain4jChatComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.langchain4j-chat", configuration, target);
            }
            @Override
