== workday - Spring Boot Auto-Configuration
...
| *camel.component.workday.basic-property-binding* | Whether the component should use basic property binding (Camel 2.x) or the newer property binding with additional capabilities | false | Boolean
