...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,MvelLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.mvel"})
public class MvelLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final MvelLanguageConfiguration configuration;

    public MvelLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.mvel.springboot.MvelLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureMvelLanguage() {
        return new LanguageCustomizer() {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.mvel", configuration, target);
                } else {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof MvelLanguage;
            }
        };
    }
}