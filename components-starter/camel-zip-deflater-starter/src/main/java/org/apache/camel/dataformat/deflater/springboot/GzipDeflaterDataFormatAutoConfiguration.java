...
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.gzip-deflater"})
public class GzipDeflaterDataFormatAutoConfiguration {
    ...
    private final GzipDeflaterDataFormatConfiguration configuration;

    public GzipDeflaterDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            ObjectProvider<org.apache.camel.CamelContext> camelContextProvider,
            org.apache.camel.dataformat.deflater.springboot.GzipDeflaterDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureGzipDeflaterDataFormatFactory() {
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.gzip-deflater", configuration, target);
            }
            @Override
