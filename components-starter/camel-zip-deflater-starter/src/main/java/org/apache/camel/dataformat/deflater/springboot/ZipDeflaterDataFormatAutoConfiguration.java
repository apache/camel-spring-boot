...
public class ZipDeflaterDataFormatAutoConfiguration {
    ...
    private final ZipDeflaterDataFormatConfiguration configuration;

    public ZipDeflaterDataFormatAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.CamelContext camelContext,
            org.apache.camel.dataformat.deflater.springboot.ZipDeflaterDataFormatConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public DataFormatCustomizer configureZipDeflaterDataFormatFactory() {
