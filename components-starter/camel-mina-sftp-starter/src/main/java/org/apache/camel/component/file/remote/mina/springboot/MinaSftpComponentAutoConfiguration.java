...
public class MinaSftpComponentAutoConfiguration {
    ...
    private final MinaSftpComponentConfiguration configuration;

    public MinaSftpComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.file.remote.mina.springboot.MinaSftpComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.mina-sftp", configuration, target);
            }
            @Override
