...
public class DropboxComponentAutoConfiguration {
    ...
    private final DropboxComponentConfiguration configuration;

    public DropboxComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.dropbox.springboot.DropboxComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DropboxComponent;
            }
        };
    }
}