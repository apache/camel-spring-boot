...
public class GroovyXmlDataFormatAutoConfiguration {
    ...
    private final GroovyXmlDataFormatConfiguration configuration;
    ...
    public GroovyXmlDataFormatAutoConfiguration(
            ...
            org.apache.camel.groovy.xml.springboot.GroovyXmlDataFormatConfiguration configuration) {
        ...
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.groovy-xml", configuration, target);
            }
            @Override
