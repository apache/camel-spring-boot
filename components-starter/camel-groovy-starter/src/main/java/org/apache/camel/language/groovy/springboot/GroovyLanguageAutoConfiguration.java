...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,GroovyLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.groovy"})
public class GroovyLanguageAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final GroovyLanguageConfiguration configuration;

    public GroovyLanguageAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.language.groovy.springboot.GroovyLanguageConfiguration configuration) {
    ...
    @Lazy
    @Bean
    public org.apache.camel.spi.LanguageCustomizer configureGroovyLanguage() {
        return new LanguageCustomizer() {
            ...
            public void configure(String name, Language target) {
                if (target instanceof CamelContextAware cca && cca.getCamelContext() != null) {
                    CamelPropertiesHelper.copyConfigurationProperties(cca.getCamelContext(), applicationContext,
                            "camel.language.groovy", configuration, target);
                } else {
            ...
            public boolean isEnabled(String name, Language target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof GroovyLanguage;
            }
        };
    }
}