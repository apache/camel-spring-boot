...
@ConditionalOnHierarchicalProperties({"camel.dataformat", "camel.dataformat.groovy-json"})
public class GroovyJSonlDataFormatAutoConfiguration {
    ...
    private final GroovyJSonlDataFormatConfiguration configuration;
    ...
    public GroovyJSonlDataFormatAutoConfiguration(
            ...
            org.apache.camel.groovy.json.springboot.GroovyJSonlDataFormatConfiguration configuration) {
        ...
        return new DataFormatCustomizer() {
            ...
            public void configure(String name, DataFormat target) {
                CamelPropertiesHelper.copyConfigurationProperties(camelContextProvider.getObject(), applicationContext,
                        "camel.dataformat.groovy-json", configuration, target);
            }
            @Override
