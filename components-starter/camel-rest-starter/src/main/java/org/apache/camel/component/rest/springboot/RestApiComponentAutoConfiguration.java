...
@Conditional({ConditionalOnCamelContextAndAutoConfigurationBeans.class,
        RestApiComponentAutoConfiguration.GroupConditions.class})
@AutoConfigureAfter(CamelAutoConfiguration.class)
@EnableConfigurationProperties({ComponentConfigurationProperties.class,
        RestApiComponentConfiguration.class})
public class RestApiComponentAutoConfiguration {
    ...
    static class GroupConditions extends GroupCondition {
        public GroupConditions() {
            super("camel.component", "camel.component.rest-api");
        }
    }
    ...
    public RestApiComponent configureRestApiComponent() throws Exception {
        ...
        if (ObjectHelper.isNotEmpty(customizers)) {
            for (ComponentCustomizer<RestApiComponent> customizer : customizers) {
