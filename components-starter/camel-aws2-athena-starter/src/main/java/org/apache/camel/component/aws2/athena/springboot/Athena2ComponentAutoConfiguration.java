 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Athena2ComponentConverter.class})
...
public class Athena2ComponentAutoConfiguration {
    ...
    private final Athena2ComponentConfiguration configuration;

    public Athena2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.athena.springboot.Athena2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-athena", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Athena2Component;
            }
        };
    }
}