 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, SolrComponentConverter.class})
...
public class SolrComponentAutoConfiguration {
    ...
    private final SolrComponentConfiguration configuration;

    public SolrComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.solr.springboot.SolrComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof SolrComponent;
            }
        };
    }
}