 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Translate2ComponentConverter.class})
...
public class Translate2ComponentAutoConfiguration {
    ...
    private final Translate2ComponentConfiguration configuration;

    public Translate2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.translate.springboot.Translate2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-translate", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Translate2Component;
            }
        };
    }
}