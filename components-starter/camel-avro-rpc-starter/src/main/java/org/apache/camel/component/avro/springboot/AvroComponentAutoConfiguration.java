 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, AvroComponentConverter.class})
...
public class AvroComponentAutoConfiguration {
    ...
    private final AvroComponentConfiguration configuration;

    public AvroComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.avro.springboot.AvroComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.avro", configuration, target);
            }
            @Override
