...
@DirtiesContext
@CamelSpringBootTest
@SpringBootTest(classes = { CamelAutoConfiguration.class, KameletLocalBeanGroovyExternalTest.class, })
        ...
        return new RouteBuilder() {
            ...
            public void configure() {
                routeTemplate("whereTo").templateParameter("bar") // name of bar
                        .templateBean("myBar", "groovy", "resource:classpath:mybar.groovy").from("kamelet:source")
