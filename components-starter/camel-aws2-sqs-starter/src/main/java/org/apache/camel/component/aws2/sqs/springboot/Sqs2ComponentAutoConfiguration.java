 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Sqs2ComponentConverter.class})
...
public class Sqs2ComponentAutoConfiguration {
    ...
    private final Sqs2ComponentConfiguration configuration;

    public Sqs2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.sqs.springboot.Sqs2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-sqs", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Sqs2Component;
            }
        };
    }
}