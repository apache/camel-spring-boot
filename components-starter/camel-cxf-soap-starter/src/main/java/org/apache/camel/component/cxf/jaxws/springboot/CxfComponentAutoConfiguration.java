 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, CxfComponentConverter.class})
...
public class CxfComponentAutoConfiguration {
    ...
    private final CxfComponentConfiguration configuration;

    public CxfComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.cxf.jaxws.springboot.CxfComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof CxfComponent;
            }
        };
    }
}