 ...
 */
@ConfigurationProperties(prefix = "camel.component.alibaba-mns")
public class MNSComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the alibaba-mns component. This
