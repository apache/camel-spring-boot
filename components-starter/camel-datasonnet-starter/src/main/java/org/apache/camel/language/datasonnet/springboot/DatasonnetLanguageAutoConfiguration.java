...
@EnableConfigurationProperties({LanguageConfigurationProperties.class,DatasonnetLanguageConfiguration.class})
@ConditionalOnHierarchicalProperties({"camel.language", "camel.language.datasonnet"})
public class DatasonnetLanguageAutoConfiguration {
    ...
    @Autowired
    private DatasonnetLanguageConfiguration configuration;
