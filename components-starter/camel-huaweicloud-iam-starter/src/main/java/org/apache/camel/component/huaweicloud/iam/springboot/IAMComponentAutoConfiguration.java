...
@ConditionalOnHierarchicalProperties({"camel.component", "camel.component.hwcloud-iam"})
public class IAMComponentAutoConfiguration {

    private final ApplicationContext applicationContext;
    private final IAMComponentConfiguration configuration;

    public IAMComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.huaweicloud.iam.springboot.IAMComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.hwcloud-iam", configuration, target);
            }
            @Override
