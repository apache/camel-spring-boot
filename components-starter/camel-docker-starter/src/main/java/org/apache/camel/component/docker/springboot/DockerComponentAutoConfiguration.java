 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, DockerComponentConverter.class})
...
public class DockerComponentAutoConfiguration {
    ...
    private final DockerComponentConfiguration configuration;

    public DockerComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.docker.springboot.DockerComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof DockerComponent;
            }
        };
    }
}