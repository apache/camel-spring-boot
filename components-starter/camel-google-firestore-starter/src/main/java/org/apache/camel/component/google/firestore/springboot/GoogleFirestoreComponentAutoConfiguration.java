 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, GoogleFirestoreComponentConverter.class})
...
public class GoogleFirestoreComponentAutoConfiguration {
    ...
    private final GoogleFirestoreComponentConfiguration configuration;

    public GoogleFirestoreComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.google.firestore.springboot.GoogleFirestoreComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.google-firestore", configuration, target);
            }
            @Override
