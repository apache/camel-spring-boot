...
import org.apache.camel.component.google.firestore.GoogleFirestoreOperations;
 ...
 */
@ConfigurationProperties(prefix = "camel.component.google-firestore")
public class GoogleFirestoreComponentConfiguration
        extends
            ComponentConfigurationPropertiesCommon {

    /**
     * Whether to enable auto configuration of the google-firestore component.
    ...
    /**
     * The Firestore client to use for operations. The option is a
     * com.google.cloud.firestore.Firestore type.
     */
    private Firestore firestoreClient;
    /**
     * The Google Cloud project ID. If not specified, it will be determined from
     * the service account key or environment.
     */
    private String projectId;
    /**
     * The Service account key that can be used as credentials for the Firestore
