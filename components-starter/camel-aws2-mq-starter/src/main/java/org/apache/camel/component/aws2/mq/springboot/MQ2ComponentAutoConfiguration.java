 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, MQ2ComponentConverter.class})
...
public class MQ2ComponentAutoConfiguration {
    ...
    private final MQ2ComponentConfiguration configuration;

    public MQ2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.mq.springboot.MQ2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-mq", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof MQ2Component;
            }
        };
    }
}