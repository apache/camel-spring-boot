 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, Kinesis2ComponentConverter.class})
...
public class Kinesis2ComponentAutoConfiguration {
    ...
    private final Kinesis2ComponentConfiguration configuration;

    public Kinesis2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.kinesis.springboot.Kinesis2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-kinesis", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof Kinesis2Component;
            }
        };
    }
}