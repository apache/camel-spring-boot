 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, KinesisFirehose2ComponentConverter.class})
...
public class KinesisFirehose2ComponentAutoConfiguration {
    ...
    private final KinesisFirehose2ComponentConfiguration configuration;

    public KinesisFirehose2ComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.aws2.firehose.springboot.KinesisFirehose2ComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.aws2-kinesis-firehose", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof KinesisFirehose2Component;
            }
        };
    }
}