 ...
 */
@AutoConfiguration(after = {CamelAutoConfiguration.class, BlobComponentConverter.class})
...
public class BlobComponentAutoConfiguration {
    ...
    private final BlobComponentConfiguration configuration;

    public BlobComponentAutoConfiguration(
            org.springframework.context.ApplicationContext applicationContext,
            org.apache.camel.component.azure.storage.blob.springboot.BlobComponentConfiguration configuration) {
        ...
        return new ComponentCustomizer() {
            ...
            public void configure(String name, Component target) {
                CamelPropertiesHelper.copyConfigurationProperties(target.getCamelContext(), applicationContext,
                        "camel.component.azure-storage-blob", configuration, target);
            }
            @Override
            public boolean isEnabled(String name, Component target) {
                return HierarchicalPropertiesEvaluator.evaluate(
                    ...
                    && target instanceof BlobComponent;
            }
        };
    }
}