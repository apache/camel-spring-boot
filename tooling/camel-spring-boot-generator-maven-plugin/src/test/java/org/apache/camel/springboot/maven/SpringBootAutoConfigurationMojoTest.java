...
class SpringBootAutoConfigurationMojoTest {
    ...
    void testDataFormatBodyBindsStrictly() {
        ...
        // on this branch DataFormatAutoConfiguration still injects a plain CamelContext field rather than an
        // ObjectProvider<CamelContext>, so the generated customizer binds through that field directly
        assertThat(body).contains("CamelPropertiesHelper.copyConfigurationProperties(camelContext,"
    ...
    void testLanguageBodyBindsStrictly() {
        ...
        // on this branch LanguageAutoConfiguration still injects a plain CamelContext field, and the generated
        // customizer never grew the CamelContextAware guard that main's template has, so it binds through that
        // field directly
        assertThat(body).contains("CamelPropertiesHelper.copyConfigurationProperties(camelContext,"
