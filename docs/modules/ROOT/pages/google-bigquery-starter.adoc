...
| *camel.component.google-bigquery-sql.connection-factory* | ConnectionFactory to obtain connection to Bigquery Service. If non provided the default one will be used. The option is a org.apache.camel.component.google.bigquery.GoogleBigQueryConnectionFactory type. |  | GoogleBigQueryConnectionFactory
...
| *camel.component.google-bigquery.connection-factory* | ConnectionFactory to obtain connection to Bigquery Service. If non provided the default one will be used. The option is a org.apache.camel.component.google.bigquery.GoogleBigQueryConnectionFactory type. |  | GoogleBigQueryConnectionFactory
