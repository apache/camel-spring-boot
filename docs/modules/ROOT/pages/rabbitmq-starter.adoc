...
| *camel.component.rabbitmq.connection-factory-exception-handler* | Custom rabbitmq ExceptionHandler for ConnectionFactory. The option is a com.rabbitmq.client.ExceptionHandler type. |  | String
