...
:page-partial:
:doctitle: Camel Spring Boot Starter for huaweicloud-functiongraph

== Spring Boot Auto-Configuration

When using huaweicloud-functiongraph with Spring Boot make sure to use the following Maven dependency to have support for auto configuration:
