...
| xref:latest@components::apns-component.adoc[APNS] | camel-apns-starter | Stable | 2.8 | *deprecated* Send notifications to Apple iOS devices.
...
| xref:latest@components::google-functions-component.adoc[GoogleCloudFunctions] | camel-google-functions-starter | Preview | 3.9 | Manage and invoke Google Cloud Functions
...
| xref:latest@components::kamelet-reify-component.adoc[Kamelet Reify] | camel-kamelet-reify-starter | Stable | 3.6 | To call Kamelets (indirectly)
