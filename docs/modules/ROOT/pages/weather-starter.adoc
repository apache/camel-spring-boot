...
| *camel.component.weather.http-client* | To use an existing configured http client (for example with http proxy). The option is a org.apache.http.impl.client.CloseableHttpClient type. |  | String
