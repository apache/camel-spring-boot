...
public class CamelAwsBedrockTest extends AbstractSpringBootTestSupport {
    ...
    public static ITestConfig createTestConfig() {
        return new ITestConfigBuilder().module(inferModuleName(CamelAwsBedrockTest.class)).build();
    }
