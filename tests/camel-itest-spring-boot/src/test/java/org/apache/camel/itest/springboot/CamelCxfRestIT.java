...
public class CamelCxfRestIT extends AbstractSpringBootBaseTestSupport {

    @Override
    protected ArchetypeConfig getArchetypeConfig() {
        return baseArchetypeConfig()
                .property("spring.autoconfigure.exclude=org.springframework.boot.validation.autoconfigure.ValidationAutoConfiguration")
                .build();
    }

    @Test
    void componentTest() {
        assertComponent("cxfrs");
    }
}
